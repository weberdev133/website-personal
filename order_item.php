    ...
    <div class="card">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_orderitem.php"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="floating input">Jumlah Porsi</label>
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-lg-7">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="pelanggan" placeholder="Catatan"
                                            name="catatan">
                                        <label for="pelanggan">Catatan</label>
                                    </div>
                                </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo number_format($row['harga'], 0, ',', '.') ?>
                                                </td>
                                                <td><?php echo $row['jumlah'] ?></td>
                                                <td><?php echo $row['status'] ?></td>
                                                <td><?php echo $row['catatan'] ?></td>
                                                <td><?php echo number_format($row['harganya'], 0, ',', '.') ?>
                                                </td>
                                            </tr>
                                            <?php
                                            $total += $row['harganya'];
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="floating input">Nominal Uang</label>
                                            <div class="invalid-feedback">
        ...
        <div>
            <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary disabled" : "btn btn-success"; ?>"
                data-bs-toggle="modal" data-bs-target="#tambahItem"><i class="bi bi-plus"></i>
                Tambah Item</button>
